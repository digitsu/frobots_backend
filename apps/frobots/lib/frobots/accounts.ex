defmodule Frobots.Accounts do
  ...
  def get_user_by_email_and_password(email, password)
    ...
    if User.valid_password?(user, password) do
      ...
      if user && user.hashed_password_old != nil && User.verify_pbkdf_hash?(user.hashed_password_old, password) do
        {:ok, user} =
  ...
  @doc """
  Returns true if the user is marked as admin, false otherwise

  ## Examples

  iex> user_is_admin?(%Frobots.Accounts.User{name: "test", admin: true} )
  true
  """
  def user_is_admin?(user) do
    user != nil and Map.get(user, :admin, false)
  end
