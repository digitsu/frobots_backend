defmodule Frobots.Api do
  ...
  def _frobot_insert_multi(user, frobot_attrs) do
    ...
    |> Multi.insert(:scanner_inst_mk2, Equipment.create_equipment_changeset(user, "Scanner", :Mk2))
    |> Multi.insert(:missile_inst_mk2, Equipment.create_equipment_changeset(user, "Missile", :Mk2))
    |> Multi.insert(
      :xframe_inst_mk3,
    ...
    |> Multi.insert(:scanner_inst_mk3, Equipment.create_equipment_changeset(user, "Scanner", :Mk3))
