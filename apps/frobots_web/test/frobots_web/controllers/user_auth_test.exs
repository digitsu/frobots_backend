defmodule FrobotsWeb.UserAuthTest do
  ...
  @remember_me_cookie "_frobots_web_user_remember_me"
  ...
  describe "log_in_user/3" do
    ...
    test "redirects to the configured path", %{conn: conn, user: user} do
      conn = conn |> put_session(:user_return_to, "/home") |> UserAuth.log_in_user(user)
      assert redirected_to(conn) == "/home"
    end
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      FrobotsWeb.Endpoint.subscribe(live_socket_id)
