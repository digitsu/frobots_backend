defmodule FrobotsWeb.Components.UI do
  ...
  # def flag_options_dropdown(assigns) do
  #   ~H"""
  #   <.dropdown id={@id}>
  #     <:link navigate={home_index_path(@current_user)}>Report post</:link>
  #     <:link navigate={Routes.settings_path(Endpoint, :edit)}>Report author</:link>
